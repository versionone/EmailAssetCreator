...
public class MailChecker
{
    ...
    public void DeleteMessagesOnServer(Message RequestEmail, string ProjectScope)
    {
            ...
            using (Pop3Client client = new Pop3Client())
            {
                ...
                if(client.Connected == true)
                {
                    ...
                    for (int messageItem = messageCount; messageItem > 0; messageItem--)
                    {
                        ...
                        if (client.GetMessageHeaders(messageItem).MessageId == RequestEmail.Headers.MessageId)
                        {
                            // Delete
