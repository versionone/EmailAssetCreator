...
namespace VersionOne_Asset_Creator
{
    ...
    class SMTPResponse
    {
        ...
        public void SendResponse(Message OriginalMail, string DefectInfo, string ProjectScope)
        {
            V1Logging Logs = new V1Logging();
            string MailBody = "Thanks for submitting your defect, the VersionOne defect ID is " + DefectInfo;
            ...
            //MailMessage mail = new MailMessage("versiononetesting@yahoo.com", "terry.densmore@versionone.com", "VersionOne Defect Submission", MailBody);


            MailMessage mail = new MailMessage(ToEmailAddress, OriginalMail.Headers.From.ToString(), "VersionOne Defect Submission", MailBody);
            ...
            Debug.WriteLine("Sending Message To: " + OriginalMail.Headers.From.ToString() + "Defect Info: " + MailBody);
