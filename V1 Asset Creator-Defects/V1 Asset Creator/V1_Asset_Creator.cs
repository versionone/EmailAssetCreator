    ...
    public partial class V1_Asset_Creator : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                ...
                eventLog1.WriteEntry("Operation - V1 Asset Creator Service Started");
            }
            catch (Exception e)
            {
        ...
        {
            // write an entry to the log
            eventLog1.WriteEntry("Operation - V1 Asset Creator Service Stopped");
        }
        ...
        private static void CheckMail(Object source, ElapsedEventArgs e)
        {
            ...
            if (Messages.Count != 0 && V1TestResult == true)
            {
                ...
                V1Connection.CreateDefect(V1Instance, Messages);
            }

            Logs.LogEvent("Operation - V1 Asset Creator Check Complete.");
